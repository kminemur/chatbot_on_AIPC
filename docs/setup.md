...
## Expected Output
初回セットアップで Hugging Face repo に OpenVINO 済みファイルがない場合:
```text
Syncing Python environment...
Preparing model from SakanaAI/TinySwallow-1.5B-Instruct...
Exporting SakanaAI/TinySwallow-1.5B-Instruct to OpenVINO format. This can take a while.
